# team-19 Platanus Hack 26: CDMX Project
...
- Jose Angel Lopez ([@joseangelchepo](https://github.com/joseangelchepo))
- Luisa Fernanda Guerra Varon ([@0luisafernanda](https://github.com/0luisafernanda))
- Gerson Estrada Lopez ([@gersonel](https://github.com/gersonel))
...
2. Point your local `origin` at **both** repos, so a single `git push` updates each one:
   ...
   git remote set-url --add --push origin https://github.com/platanus-hack/platanus-hack-26-mx-team-19.git
